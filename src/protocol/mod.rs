...
mod test {
    ...
    fn serialize_ping() {
        ...
        assert_eq!(ping.serialize(), PING_RAW);
    }

    #[test]
    fn serialize_echo() {
        let echo = Request::Echo("Hello, world!".to_string());
        assert_eq!(echo.serialize(), ECHO_RAW);
    }
    ...
    #[test]
    fn deserialize_ping_various_case() {
        let mut buffer = "*1\r\n$4\r\nPING\r\n".to_string();
        assert_eq!(Request::deserialize(&mut buffer).unwrap(), Request::Ping);
        let mut buffer = "*1\r\n$4\r\npiNG\r\n".to_string();
        assert_eq!(Request::deserialize(&mut buffer).unwrap(), Request::Ping);
    ...
    fn deserialize_incomplete_message() {
        // If message is incomplete, buffer must remain intact.
        let mut buffer = "*1\r\n$4\r\n".to_string();
    ...
    #[test]
    fn deserialize_incomplete_message_with_prefix() {
        // If message is incomplete, buffer must remain intact.
        static PREFIX: &str = "\r\n$4s";
    ...
    #[test]
    fn deserialize_ping_with_prefix() {
    ...
    #[test]
    fn deserialize_ping_with_prefix_and_postfix() {
    ...
    #[test]
    fn deserialize_ping_and_then_echo() {
